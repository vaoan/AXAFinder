...
import actionsSettings from '../../../../models/redux/settings/actions'
...
class MenuLeft extends React.Component {
  ...
  onCollapse = (value, type) => {
    ...
    dispatch({
      type: actionsSettings.CHANGE_SETTING,
      payload: {
    ...
    return (
      ...
      >
        <div className={styles.logo}>
          <div className={`${styles.logoContainer} full-centering`}>
            <img
        ...
        >
          ...
          <div className={styles.buyPro} style={{ display: 'none' }}>
            <p>
